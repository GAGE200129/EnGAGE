...
_setDirectionalLight(_addComponent(entity, DIRECTIONAL_LIGHT), 0.6, -1, -0.91, 1, 1, 1, 0.5)
local entity = _createEntity()
_setName(_addComponent(entity, NAME), "Test")
entity_transform = _addComponent(entity, TRANSFORM)
_setPosition(entity_transform, -4.11257, 0.183837, 2.94658)
_setRotation(entity_transform, 1, 0, 0, 0)
_setScale(entity_transform, 1, 1, 1)
_setModel(_addComponent(entity, MODEL_RENDERER), "Resources/Models/AnimationTest.glb")
_setPointLight(_addComponent(entity, POINT_LIGHT), 1, 0, 0, 1, 1, 1, 1)
local entity = _createEntity()
_setName(_addComponent(entity, NAME), "Player")
entity_transform = _addComponent(entity, TRANSFORM)
_setPosition(entity_transform, 0.193972, 2.1066, -1.41928)
_setRotation(entity_transform, 1, 0, 0, 0)
...
_setPointLight(_addComponent(entity, POINT_LIGHT), 0, 1, 0, 1, 1, 1, 1)
local entity = _createEntity()
_setName(_addComponent(entity, NAME), "Sun2")
_setDirectionalLight(_addComponent(entity, DIRECTIONAL_LIGHT), 0.72, -1, 0.49, 1, 1, 1, 0.5)
